...
export const color1 = lightTheme ? 'white':'#061a44';
export const color2 = lightTheme ? 'white':'#010e2c';
export const color3 = lightTheme ? 'white':'#42ff3a';
...
export const lightBlueBackground = `background-color: ${color1}`;
...
export const boxBoxShadow= `box-shadow: 0px 0px 2px 2px #e41111`
